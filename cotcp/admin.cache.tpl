                ...
                <div class="list-group mb-3">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-2 text-center">{ADMIN_CACHE_REALM}</div>
                            <div class="col-12 col-md-2 text-center">{ADMIN_CACHE_EXPIRE}</div>
                            <div class="col-12 col-md-2 text-center">{ADMIN_CACHE_SIZE}</div>
